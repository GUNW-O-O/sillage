  ...
  return (
    <main className="max-w-[1000px]">
      ...
      <p className="mt-2 mb-6 text-[13px] text-muted">
        판매자 노트와 <span className="text-ink">내 기록</span> 의 향이 같은 줄에 묶인다 —
        붙이는 것은 표현 단위라 출처가 무관하다. 붙이면 그 표현을 쓰는 모든 원두가 함께 붙고
        판매자 노트 쪽만 noteSetHash 가 재계산된다. 재계산 결과 다른 원두와 키가 같아지면
        적용하지 않고 알린다.
      </p>
